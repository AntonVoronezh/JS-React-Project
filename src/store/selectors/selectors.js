...
const getModelsState = createSelector(
	[getModels],
	models => models
);
...
const getFieldsState = createSelector(
	[getFields],
	fields => fields
);
...
const getFieldsErrorState = createSelector(
	[getFieldsError],
	error => error
);
...
const getModelsErrorState = createSelector(
	[getModelsError],
	error => error
);
...
const getSyncErrorState = createSelector(
	[getSyncError],
	error => error
);
...
const getSyncStatusState = createSelector(
	[getSyncStatus],
	error => error
);
